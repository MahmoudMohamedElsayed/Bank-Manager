...
private:
    ...
    static void _GoBackToCurrencyExchangeMenueOption()
    {
        cout << setw(37) << left << "" << "\n\tPress any key to go back to Currency Exchange Menue Option...\n";
    ...
    static void _PerformCurrenciesMainMenueOptions(enCurrenciesMainMenueOptions CurrencyExchangeMenueOption)
    {
        ...
        case enCurrenciesMainMenueOptions::eListCurrencies:
        {
            ...
            _GoBackToCurrencyExchangeMenueOption();
            break;
        }
